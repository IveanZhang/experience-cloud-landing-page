...
const page3Data = [
  {
    title: 'UUWill - Consulting Investment',
    url: 'http://ci.happyneg.net',
    img: 'https://i.postimg.cc/6WRqMfHw/Fire-Shot-Capture-003-UUwill-Consulting-ci-happyneg-net.png',
  },
  {
    title: 'Darong travel',
    url: 'http://darong.happyneg.net',
    img: 'https://i.postimg.cc/8DSz1WKJ/Fire-Shot-Capture-004-darong-happyneg-net.png',
  },
  {
    title: 'UUWill - Car Rental',
    url: 'http://car.happyneg.net',
    img: 'https://i.postimg.cc/2r5m6x46/Fire-Shot-Capture-005-UUWILL-Car-Rental-car-happyneg-net.png',
  },
  {
    title: 'UUWill - Esate',
    url: 'http://house.happyneg.net',
    img: 'https://i.postimg.cc/gmBp66DK/Fire-Shot-Capture-006-UUWILL-Corporate-house-happyneg-net.png',
  },
  {
    title: 'UUWill - Edu',
    url: 'http://eduen.happyneg.net',
    img: 'https://i.postimg.cc/w9Cdw8ny/Fire-Shot-Capture-007-Edu-En-Edu-En-eduen-happyneg-net.png',
  }
];
const svgBgChild = [
  (
...
export default class Page3 extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { inImage: false, currentID: -1 }
  ...
  animationEnd(e) {
    if (this.state.inImage && e.target.dataset.index === this.state.currentID) {
      e.target.style.backgroundPositionY = e.target.style.backgroundPositionY === '0%' ? '100%' : '0%';
    }
  }
  ...
  onMouseEnter(e) {
    ...
    e.target.style.backgroundPositionY = '100%';
  }
  ...
  renderItems() {
    return page3Data.map((item, i) => {
      return (<Col key={i.toString()} md={12} xs={24} sm={24} lg={12} xl={8} className="page3-block">
        <div className="item-wrapper">
          <div className="img-wrapper">
            <a href={item.url} target="_blank" >
              <div className="ant-spin-nested-loading">
                <div className="ant-spin-container">
                  <div data-index={i} className="img" style={{ backgroundImage: 'url(' + item.img + ')', backgroundPositionY: '0%' }} onTransitionEnd={this.animationEnd} onMouseEnter={this.onMouseEnter} onMouseLeave={this.onMouseLeave}></div>
                </div>
              </div>
            </a>
          </div>
    ...
    return (
        <IntlProvider locale="en">
          <div className="home-page-wrapper page3" id="page3" >
            <div className="page" >
              <h2>项目案例</h2>
              <ScrollOverPack component={Row} playScale="0.4">
